    ...
    class Program
    {
        static void Main(string[] args) {
            var central = new CentralDeExercicios(new Dictionary<string, Action>() {
                ...
                { "Delegate com Função Anônima - Métodos e Funções", DelegateFuncAnonima.Executar},
                { "Passando Delegate como Parâmetro - Métodos e Funções", DelegatesComoParametros.Executar},
